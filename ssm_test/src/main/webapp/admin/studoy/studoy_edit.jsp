...
<script type="text/javascript" src="../../js/layer/layer.js"></script>
	...
	var customerTypeidbox;
		function doeditStuDoy(index){
			...
			var postData={"doyId":parent.eid,
					doyName:$("#doyName").val().trim(),
					doyRemark: $("#doyRemark").val().trim()
					}; 
					
			$.ajax({
				  type: "post",
				  url: "editStuDoy.action",
				  data:postData,
				  dataType: "json",
				  success: function(rd){
		...
		$(function(){
			$.ajax({
			   type: "POST",
			   url: "selStuDoyByID.action",
			   data: "doyId="+parent.eid,
			  dataType:"json",
			   success: function(msg){
			       if(msg.succ){
			    	   $("#doyName").val(msg.data.doyName);
			    	   $("#doyRemark").val(msg.data.doyRemark);
