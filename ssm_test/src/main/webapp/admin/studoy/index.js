				   ...
				   $("#main_layout").ligerLayout({
	                ...
	                tab = $("#layout_center").ligerTab({
	                    ...
	                    onBeforeSelectTabItem: function(tabid){
	                    	var nodes = menuTreeObject.getNodesByParam("mdoyId", tabid, null);
	                    	if(nodes.length>0){
					...
					callback: {
						beforeClick:function(treeId, treeNode, clickFlag){
							...
							if(treeNode.isParent){
							 ...
							 if(treeNode.mdoyUrl!= null && treeNode.mdoyUrl!= "#"){
								 f_addTab(treeNode.mdoyId,treeNode.mdoyName,makeUrl(treeNode.mdoyUrl));
								 selected =  true;
							 }
							 return selected;
